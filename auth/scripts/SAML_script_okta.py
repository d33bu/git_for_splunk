...
def getUserInfo(args):
    ...
    while groupsUrl:
        ...
        logger.debug("Successfully obtained group names for username={} groups={}".format(username, [group['profile']['name'] for group in groupAttributes]))
    ...
    if encodeOutput:
        logger.debug("base64 encoding script output")
        ...
        logger.debug("Not base64 encoding script output")
