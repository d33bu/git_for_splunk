...
from splunkupgrade.processors.rest_proxy_processors import RestProxyStatusProcessor
...
class StatusRestEndpoint(PersistentServerConnectionApplication):
    def __init__(
        self,
    ...
    def handle(self, in_string: bytes) -> JsonObject:
        return RestProxyStatusProcessor().handle(in_string)
