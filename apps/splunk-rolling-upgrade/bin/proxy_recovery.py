...
from splunkupgrade.processors.rest_proxy_processors import RestProxyRecoveryProcessor
...
class RecoveryRestEndpoint(PersistentServerConnectionApplication):
    def __init__(
        self,
    ...
    def handle(self, in_string: bytes) -> JsonObject:
        return RestProxyRecoveryProcessor().handle(in_string)
