...
from cloudgateway.private.util.constants import HEADER_CONTENT_TYPE, HEADER_SPACEBRIDGE_CLIENT_ID, APPLICATION_PROTOBUF
...
def _process_unregister_request(log: logging.Logger, device_id, system_authtoken):
    ...
    headers = {
        HEADER_SPACEBRIDGE_CLIENT_ID: public_key_hash,
...
def device_pairing_confirmation_request(log: logging.Logger,
    ...
    try:
        response = requests.put(
            ...
            headers={
                HEADER_CONTENT_TYPE: APPLICATION_PROTOBUF,
                HEADER_SPACEBRIDGE_CLIENT_ID: str(auth_header)
            },
