...
async def delete_all_devices(log: logging.Logger, user, system_authtoken, user_authtoken):
    """
    ...
    return await _delete_devices(log, user, all_devices, system_authtoken, user_authtoken)
