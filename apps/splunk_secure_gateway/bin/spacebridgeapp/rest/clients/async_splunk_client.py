...
class AsyncSplunkClient(AsyncNonSslClient):
    ...
    def get_search_data_uri(self, owner, app_name):
        ...
        """
        return self.get_namespaced_rest_endpoint_uri(f'{owner}/{app_name}/search/v2/jobs')
    ...
    def async_get_reports(self, auth_header, owner, max_results=0, offset=0, app_name=None, scheduled=False, report_ids=None, search_term=None):
        """
        ...
        query = create_dashboard_report_search_query(app_names=app_names,
        ...
        ns_app_name = app_name or "-"
        rest_uri = self.get_namespaced_rest_endpoint_uri(f"-/{ns_app_name}/saved/searches")
        return self.async_get_request(uri=rest_uri, params=params, auth_header=auth_header)
