...
class AppV2(SpacebridgeAppBase):
    """Pair of app name and display app name.
    """

    def __init__(self, app_name="", display_app_name="", author="", is_dashboard_hidden=False, dashboard_count=0, total_report_count=0, scheduled_report_count=0):
        self.app_name = app_name
        self.display_app_name = display_app_name
        self.author = author
        self.is_dashboard_hidden = is_dashboard_hidden
        self.dashboard_count = dashboard_count
        self.total_report_count = total_report_count
        self.scheduled_report_count = scheduled_report_count
    ...
    def set_protobuf(self, proto):
        ...
        proto.appName = self.app_name
        proto.displayAppName = self.display_app_name
        proto.isDashboardHidden = self.is_dashboard_hidden
        proto.dashboardCount = self.dashboard_count
        proto.totalReportCount = self.total_report_count
        proto.scheduledReportCount = self.scheduled_report_count
    ...
    def from_protobuf(self, proto):
        ...
        self.app_name = proto.appName
        self.display_app_name = proto.displayAppName
        self.is_dashboard_hidden = proto.isDashboardHidden
        self.dashboard_count = proto.dashboardCount
        self.total_report_count = proto.totalReportCount
        self.scheduled_report_count = proto.scheduledReportCount
    ...
    def to_protobuf(self):
        ...
        proto = request_pb2.AppListResponseV2.App()
        self.set_protobuf(proto)
        return proto
