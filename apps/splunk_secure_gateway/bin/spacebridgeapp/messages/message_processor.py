...
from spacebridgeapp.request.request_list import SINGLE_REQUESTS, SUBSCRIPTION_REQUESTS, ENCRYPTION_CONTEXT, \
    ClientRequestDomain
...
async def process_message(log: logging.Logger,
    ...
    if client_application_message.HasField(CLIENT_SINGLE_REQUEST):
        ...
        log.warning("No suitable message type found client application request")
    ...
    async_request_client.on_request(device_key, auth_header)
