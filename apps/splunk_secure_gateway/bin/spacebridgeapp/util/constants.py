...
# Clients User Agents
USER_AGENT_EDGE_HUB = "splunk_edge_hub"
...
ID = 'id'
IS_PRIVATE_SPACEBRIDGE = 'is_private_spacebridge'
PUBLIC_SPACEBRIDGE_DOMAIN = '.spacebridge.splunkcx.com'
...
# Splunk Web API
DASHBOARD_SEARCH_QUERY = '(isDashboard=1 AND isVisible=1 AND (rootNode="form" OR rootNode="dashboard"))'
