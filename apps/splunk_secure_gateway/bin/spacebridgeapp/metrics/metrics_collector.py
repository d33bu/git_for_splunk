...
from spacebridgeapp.rest.services.splunk_service import get_current_context, get_deployment_info, get_all_users
...
class NumAlertsMetric(SpacebridgeAppMetric):
    ...
    def calculate(self):
        collection_size = 0
        for user in get_all_users(self.session_token):
