...
_VERSION__1_0_0 = parse("1")
UDF_DASHBOARD_VERSION = parse("2")


def _parse_dashboard_version(content: Dict):
    version = content.get("version")
    return _VERSION__1_0_0 if not version else parse(str(version))


def _is_udf_data(content: Dict):
    return _parse_dashboard_version(content) >= UDF_DASHBOARD_VERSION
