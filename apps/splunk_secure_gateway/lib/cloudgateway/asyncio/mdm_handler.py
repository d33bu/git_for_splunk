...
async def handle_mdm_authentication_request(mdm_auth_request_proto, encryption_context, server_context, logger,
    ...
    try:
        ...
        if login_type == constants.SAML:
            ...
            session_token = await server_context.create_session_token(username, password)
    ...
    r = await mdm.async_send_confirmation_result(mdm_authentication_confirmation_request, encryption_context,
