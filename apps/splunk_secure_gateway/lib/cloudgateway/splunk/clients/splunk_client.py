...
def create_jwt_token(session_key, data):
    """
    Create a JWT token in Splunk core
    :param session_key: A raw system auth token
    :param data: Dictionary of jwt token parameters
    """
    base_uri = rest.makeSplunkdUri()
    uri = "{}services/authorization/tokens".format(base_uri)
    params = {
        'output_mode': 'json'
    }
