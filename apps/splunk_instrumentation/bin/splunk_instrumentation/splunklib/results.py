...
from splunk_instrumentation.splunklib.six import deprecated
...
try:
    from splunk_instrumentation.splunklib.six.moves import cStringIO as StringIO
except:
    from splunk_instrumentation.splunklib.six import StringIO
